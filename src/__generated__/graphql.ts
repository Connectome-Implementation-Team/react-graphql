...
export type FetchQuery = { __typename?: 'Query', fetch: { __typename: 'ArchiveComponent', name: string, description?: string | null } | { __typename: 'ArchiveOrganization', name: string, description?: string | null } | { __typename: 'Book', name: string, description?: string | null } | { __typename: 'Dataset', name: string, description?: string | null, author: Array<{ __typename?: 'Organization', iri: string, name: string } | { __typename?: 'Person', iri: string, name: string }> } | { __typename: 'Organization', name: string, description?: string | null } | { __typename: 'Person', name: string, description?: string | null } | { __typename: 'ResearchProject', name: string, description?: string | null } | { __typename: 'ScholarlyArticle', iri: string, name: string, abstract?: string | null, description?: string | null, author: Array<{ __typename?: 'Organization', iri: string, name: string } | { __typename?: 'Person', iri: string, name: string }> } };
